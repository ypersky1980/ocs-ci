...
@tier1
class TestPgSQLWorkloadRawBlockPV(ManageTest):
    """
    Deploy an PGSQL workload using operator
    """
    def test_sql_workload_rawblockpv(self, ripsaw):
        """
        This is a basic pgsql workload with raw block pv
        """
        # Deployment postgres
        ...
        ripsaw.setup_postgresql(rawblockpv=True)
